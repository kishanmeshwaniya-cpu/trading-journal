...
```", "").strip()
                        ...
                        # 3. Actionable Guidance (Visual Cards)
                        ...
                        for i, item in enumerate(ai_data['chart_data']):
                            with cols[i]:
                                st.markdown(f"""
                                <div style="background-color:#ffebee; padding:15px; border-radius:10px; border-left: 5px solid #d32f2f; min-height: 180px;">
                                    <h4 style="color:#d32f2f; margin-top:0;">{item['Mistake']}</h4>
                                    <p style="color:black;"><b>❌ Avoid:</b> {item['Avoid']}</p>
                                    <p style="color:black;"><b>✅ Benefit:</b> {item['Benefit']}</p>
                                </div>
